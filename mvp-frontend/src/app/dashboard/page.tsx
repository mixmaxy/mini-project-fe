...
export default function DashboardPage() {
  ...
  const fetchDashboardData = useCallback(async () => {
    try {
      ...
      // Don't show error toast for 401 since we're using mock data
                      ...
                      <>
                        {stats.charts.spendingByPeriod && (
                          <Card>
                            ...
                            <CardContent>
                              <ResponsiveContainer width="100%" height={300}>
                                <LineChart data={stats.charts.spendingByPeriod}>
                                  <CartesianGrid strokeDasharray="3 3" />
                                  <XAxis dataKey="date" />
                                  <YAxis />
                                  <Tooltip />
                        ...
                        {stats.charts.categoryDistribution && (
                          <Card>
                            <CardHeader>
                              ...
                              <ResponsiveContainer width="100%" height={300}>
                                <PieChart>
                                  <Pie
                                    ...
                                    dataKey="value"
                                  >
                                    {stats.charts.categoryDistribution.map(
                                      (entry, index) => (
                                        <Cell
                                          key={`cell-${index}`}
                                          fill={COLORS[index % COLORS.length]}
